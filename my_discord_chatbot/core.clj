(ns my-discord-chatbot.core
  (:gen-class)
  (:require [clj-http.client :as http]
            [clojure.data.json :as json]
            [gniazdo.core :as ws]
            [my-discord-chatbot.eliza :as eliza]))
...
(def token "MzI3ODU1NTQxNzI2NDc4MzM2.DC7nkw.PGCADk34PBRKe2vzLIMgb3mj3H8")

(defn d100 [type data]
  (answer-command data "!d100" (str "Here you are a random number between 1 and 100: " (+ (rand-int 100) 1))))
